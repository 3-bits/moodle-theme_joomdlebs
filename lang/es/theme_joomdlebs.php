 ...
 *
 * Spanish Language strings file for joomdlebs theme
 *
...
$string['bodybgcolor'] = 'Color de fondo de Body';
$string['linkcolor'] = 'Color del enlace';
$string['linkhovercolor'] = 'Color del enlace hover';
$string['menubgcolor'] = 'Color de fondo del Menu';

$string['bodybgcolordesc'] = 'Color de fondo del tema';
$string['linkcolordesc'] = 'Color para los enlaces';
